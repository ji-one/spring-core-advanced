...
import hello.springcoreadvanced.proxy.config.v1_proxy.ConcreteProxyConfig;
import hello.springcoreadvanced.proxy.config.v2_dynamicproxy.DynamicProxyBasicConfig;
